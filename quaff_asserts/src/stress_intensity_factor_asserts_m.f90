module stress_intensity_factor_asserts_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use quaff, only: stress_intensity_factor_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(stress_intensity_factor_t), intent(in) :: expected
        type(stress_intensity_factor_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(stress_intensity_factor_t), intent(in) :: expected
        type(stress_intensity_factor_t), intent(in) :: actual
        type(stress_intensity_factor_t), intent(in) :: tolerance
        type(result_t) :: result_
