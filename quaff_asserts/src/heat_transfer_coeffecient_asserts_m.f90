module heat_transfer_coeffecient_asserts_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use quaff, only: heat_transfer_coeffecient_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(heat_transfer_coeffecient_t), intent(in) :: expected
        type(heat_transfer_coeffecient_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(heat_transfer_coeffecient_t), intent(in) :: expected
        type(heat_transfer_coeffecient_t), intent(in) :: actual
        type(heat_transfer_coeffecient_t), intent(in) :: tolerance
        type(result_t) :: result_
