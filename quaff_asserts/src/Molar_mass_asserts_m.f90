...
contains
    pure function assertEqualsBasic(expected, actual) result(result__)
        class(MolarMass_t), intent(in) :: expected
        class(MolarMass_t), intent(in) :: actual
    ...
    pure function assertEqualsWithinAbsoluteBasic( &
        ...
        class(MolarMass_t), intent(in) :: expected
        class(MolarMass_t), intent(in) :: actual
        class(MolarMass_t), intent(in) :: tolerance
        type(Result_t) :: result__
...
end module Molar_mass_asserts_m
