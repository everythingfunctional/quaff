module inverse_molar_mass_asserts_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use quaff, only: inverse_molar_mass_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(inverse_molar_mass_t), intent(in) :: expected
        type(inverse_molar_mass_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(inverse_molar_mass_t), intent(in) :: expected
        type(inverse_molar_mass_t), intent(in) :: actual
        type(inverse_molar_mass_t), intent(in) :: tolerance
        type(result_t) :: result_
