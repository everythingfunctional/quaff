module Energy_per_temperature_amount_asserts_m
    use iso_varying_string, only: VARYING_STRING, operator(//), var_str
    use quaff, only: EnergyPerTemperatureAmount_t
...
contains
    pure function assertEqualsBasic(expected, actual) result(result__)
        class(EnergyPerTemperatureAmount_t), intent(in) :: expected
        class(EnergyPerTemperatureAmount_t), intent(in) :: actual
    ...
    pure function assertEqualsWithinAbsoluteBasic( &
        ...
        class(EnergyPerTemperatureAmount_t), intent(in) :: expected
        class(EnergyPerTemperatureAmount_t), intent(in) :: actual
        class(EnergyPerTemperatureAmount_t), intent(in) :: tolerance
        type(Result_t) :: result__
...
end module Energy_per_temperature_amount_asserts_m
