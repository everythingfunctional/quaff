module dynamic_viscosity_asserts_m
    ...
    use quaff, only: dynamic_viscosity_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(dynamic_viscosity_t), intent(in) :: expected
        type(dynamic_viscosity_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(dynamic_viscosity_t), intent(in) :: expected
        type(dynamic_viscosity_t), intent(in) :: actual
        type(dynamic_viscosity_t), intent(in) :: tolerance
        type(result_t) :: result_
