module Acceleration_asserts_m
    use iso_varying_string, only: VARYING_STRING, operator(//), var_str
    use quaff, only: Acceleration_t
...
contains
    pure function assertEqualsBasic(expected, actual) result(result__)
        class(Acceleration_t), intent(in) :: expected
        class(Acceleration_t), intent(in) :: actual
    ...
    pure function assertEqualsWithinAbsoluteBasic( &
        ...
        class(Acceleration_t), intent(in) :: expected
        class(Acceleration_t), intent(in) :: actual
        class(Acceleration_t), intent(in) :: tolerance
        type(Result_t) :: result__
...
end module Acceleration_asserts_m
