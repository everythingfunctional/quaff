...
contains
    pure function assertEqualsBasic(expected, actual) result(result__)
        class(ThermalConductivity_t), intent(in) :: expected
        class(ThermalConductivity_t), intent(in) :: actual
    ...
    pure function assertEqualsWithinAbsoluteBasic( &
        ...
        class(ThermalConductivity_t), intent(in) :: expected
        class(ThermalConductivity_t), intent(in) :: actual
        class(ThermalConductivity_t), intent(in) :: tolerance
        type(Result_t) :: result__
...
end module Thermal_conductivity_asserts_m
