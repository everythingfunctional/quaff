module acceleration_test
    ...
    use acceleration_utilities_m, only: &
...
contains
    function test_acceleration() result(tests)
        ...
        examples = make_units_examples(PROVIDED_ACCELERATION_UNITS)
        tests = describe( &
                "acceleration_t", &
                [ it( &
                ...
                , it( &
                        ...
                        check_add_subtract) &
                , it( &
                        "multiplying by one returns the original acceleration", &
                        DOUBLE_PRECISION_GENERATOR, &
                        check_multiply_by_one) &
                , it( &
                        "multiplying by zero returns zero acceleration", &
                        DOUBLE_PRECISION_GENERATOR, &
                        check_multiply_by_zero) &
                , it( &
                        "dividing by one returns the original acceleration", &
                        DOUBLE_PRECISION_GENERATOR, &
                        check_divide_by_one) &
                , it( &
                ...
                , describe( &
                        "operator(==)", &
                        [ it( &
                                "is true for the same acceleration", &
                                DOUBLE_PRECISION_GENERATOR, &
                                check_equal_with_same_number) &
                        , it( &
                                "is false for different accelerations", &
                                DOUBLE_PRECISION_GENERATOR, &
                ...
                , describe( &
                        "operator(/=)", &
                        [ it( &
                                "is false for the same acceleration", &
                                DOUBLE_PRECISION_GENERATOR, &
                                check_not_equal_with_same_number) &
                        , it( &
                                "is true for different accelerations", &
                                DOUBLE_PRECISION_GENERATOR, &
                                check_not_equal_with_different_numbers) &
                        ]) &
                , describe( &
                        "%equal(acceleration, within)", &
                        [ it( &
                                "is true for the same acceleration even for tiny tolerance", &
                                DOUBLE_PRECISION_GENERATOR, &
    ...
    pure function check_conversion_factors_are_inverse( &
        ...
        class(acceleration_unit_t), intent(in) :: to
        class(acceleration_unit_t), intent(in) :: from
        type(result_t) :: result_
    ...
    contains
        function do_check(input) result(result__)
            ...
            select type (input)
            type is (double_precision_input_t)
                original_acceleration = input%input().unit.units
                maybe_acceleration = parse_acceleration( &
                        original_acceleration%to_string_in(units))
                new_acceleration = maybe_acceleration%acceleration()
    ...
    function check_bad_string() result(result_)
        ...
        maybe_acceleration = parse_acceleration("bad")
        errors = maybe_acceleration%errors()
    ...
    function check_bad_number() result(result_)
        ...
        maybe_acceleration = parse_acceleration("bad m/s^2")
        errors = maybe_acceleration%errors()
        result_ = assert_that(errors.hasType.PARSE_ERROR, errors%to_string())
    end function
    ...
    pure function check_negation(input) result(result_)
        ...
        type is (double_precision_input_t)
            result_ = assert_equals( &
                    (-input%input()).unit.METERS_PER_SQUARE_SECOND, &
                    -(input%input().unit.METERS_PER_SQUARE_SECOND))
        class default
    ...
    pure function check_add_zero(input) result(result_)
        ...
        select type(input)
        type is (double_precision_input_t)
            acceleration = input%input().unit.METERS_PER_SQUARE_SECOND
            zero = 0.0d0.unit.METERS_PER_SQUARE_SECOND
            result_ = assert_equals(acceleration, acceleration + zero)
        class default
            result_ = fail("Expected a double_precision_input_t")
        end select
    end function
    ...
    pure function check_add_subtract(input) result(result_)
        ...
        type is (double_precision_pair_input_t)
            ...
            acceleration2 = input%second_().unit.METERS_PER_SQUARE_SECOND
            result_ = assert_equals_within_relative( &
                    acceleration1, &
                    (acceleration1 + acceleration2) - acceleration2, &
                    1.0d-8, &
                    "acceleration1 = " // acceleration1%to_string() &
                    // ", acceleration2 = " // acceleration2%to_string())
        class default
    ...
    pure function check_multiply_by_one(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration = input%input().unit.METERS_PER_SQUARE_SECOND
            result_ = assert_equals(acceleration, acceleration * 1.0d0)
        class default
            result_ = fail("Expected a double_precision_input_t")
        end select
    end function
    ...
    pure function check_multiply_by_zero(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration = input%input().unit.METERS_PER_SQUARE_SECOND
            zero = 0.0d0.unit.METERS_PER_SQUARE_SECOND
            result_ = assert_equals(zero, acceleration * 0.0d0)
        class default
            result_ = fail("Expected a double_precision_input_t")
        end select
    end function
    ...
    pure function check_divide_by_self(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration = input%input().unit.METERS_PER_SQUARE_SECOND
            result_ = assert_equals(1.0d0, acceleration / acceleration)
        class default
            result_ = fail("Expected a double_precision_input_t")
        end select
    end function
    ...
    pure function check_multiply_divide(input) result(result_)
        ...
        type is (double_precision_pair_input_t)
            ...
            result_ = assert_equals(acceleration, (acceleration * input%second_()) / input%second_())
        class default
            result_ = fail("Expected a double_precision_pair_input_t")
        end select
    end function
    ...
    pure function check_equal_with_same_number(input) result(result_)
        ...
        select type (input)
        type is (double_precision_input_t)
            the_acceleration = input%input().unit.METERS_PER_SQUARE_SECOND
            result_ = assert_that( &
                    the_acceleration == the_acceleration, &
                    the_acceleration%to_string() // " == " // the_acceleration%to_string())
        class default
    ...
    pure function check_equal_with_different_numbers(input) result(result_)
        ...
        select type (input)
        type is (double_precision_input_t)
            acceleration1 = input%input().unit.METERS_PER_SQUARE_SECOND
            acceleration2 = (input%input() + 1.0d0).unit.METERS_PER_SQUARE_SECOND
            result_ = assert_not( &
                    acceleration1 == acceleration2, &
                    acceleration1%to_string() // " == " // acceleration2%to_string())
        class default
            result_ = fail("Expected to get a double_precision_input_t")
        end select
    end function
    ...
    pure function check_equal_within_with_same_number(input) result(result_)
        ...
        type is (double_precision_input_t)
            ...
            result_ = assert_that( &
                    ...
                    "(" // the_acceleration%to_string() // ")%equal(" &
                        // the_acceleration%to_string() // ", within = " &
                        // tolerance%to_string() // ")")
        class default
            result_ = fail("Expected to get a double_precision_input_t")
        end select
    ...
    pure function check_equal_within_with_close_numbers(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration1 = input%input().unit.METERS_PER_SQUARE_SECOND
            acceleration2 = (input%input() + 0.05d0).unit.METERS_PER_SQUARE_SECOND
            tolerance = 0.1d0.unit.METERS_PER_SQUARE_SECOND
            result_ = assert_that( &
                    acceleration1%equal(acceleration2, within = tolerance), &
                    "(" // acceleration1%to_string() // ")%equal(" &
                        // acceleration2%to_string() // ", within = " &
                        // tolerance%to_string() // ")")
        class default
            result_ = fail("Expected to get a double_precision_input_t")
        end select
    ...
    pure function check_equal_within_with_different_numbers(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration1 = input%input().unit.METERS_PER_SQUARE_SECOND
            acceleration2 = (input%input() + 0.2d0).unit.METERS_PER_SQUARE_SECOND
            tolerance = 0.1d0.unit.METERS_PER_SQUARE_SECOND
            result_ = assert_not( &
                    acceleration1%equal(acceleration2, within = tolerance), &
                    "(" // acceleration1%to_string() // ")%equal(" &
    ...
    pure function check_greater_than_or_equal_with_same_numbers(input) result(result_)
        ...
        type is (double_precision_input_t)
            acceleration1 = input%input().unit.METERS_PER_SQUARE_SECOND
            acceleration2 = input%input().unit.METERS_PER_SQUARE_SECOND
            result_ = assert_that( &
                    acceleration1 >= acceleration2, &
                    acceleration1%to_string() // " >= " // acceleration2%to_string())
        class default
