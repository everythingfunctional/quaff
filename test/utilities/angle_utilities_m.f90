module angle_utilities_m
    use quaff, only: angle_unit_t
    ...
    type, extends(input_t) :: units_pair_input_t
        private
        class(angle_unit_t), allocatable :: first_
        class(angle_unit_t), allocatable :: second__
    contains
        private
...
contains
    ...
    function units_pair_input_constructor(first, second_) result(units_pair_input)
        class(angle_unit_t), intent(in) :: first
        class(angle_unit_t), intent(in) :: second_
    ...
    function first(self)
        ...
        class(angle_unit_t), allocatable :: first
    ...
    function second_(self)
        class(units_pair_input_t), intent(in) :: self
        class(angle_unit_t), allocatable :: second_
