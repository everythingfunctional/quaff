module volume_utilities_m
    use quaff, only: volume_unit_t
    ...
    type, extends(input_t) :: units_pair_input_t
        private
        class(volume_unit_t), allocatable :: first_
        class(volume_unit_t), allocatable :: second__
    contains
        private
...
contains
    ...
    function units_pair_input_constructor(first, second_) result(units_pair_input)
        class(volume_unit_t), intent(in) :: first
        class(volume_unit_t), intent(in) :: second_
    ...
    function first(self)
        ...
        class(volume_unit_t), allocatable :: first
    ...
    function second_(self)
        class(units_pair_input_t), intent(in) :: self
        class(volume_unit_t), allocatable :: second_
