module energy_per_temperature_amount_logic_ops_test
...
contains
    function test_equal_operator() result(tests)
        ...
        individual_tests(1) = it( &
                "is equal for the same energy_per_temperature_amount", &
                DOUBLE_PRECISION_GENERATOR, &
                checkEqualWithSameNumber)
        individual_tests(2) = it( &
                "is not equal for different energy_per_temperature_amounts", &
                DOUBLE_PRECISION_GENERATOR, &
                checkEqualWithDifferentNumbers)
        tests = describe("EnergyPerTemperatureAmount_t with operator(==)", individual_tests)
    ...
    function test_equal_within() result(tests)
        ...
        individual_tests(1) = it( &
                "is equal for the same energy_per_temperature_amount even for tiny tolerance", &
                DOUBLE_PRECISION_GENERATOR, &
        ...
        tests = describe("EnergyPerTemperatureAmount_t%equal with tolerance", individual_tests)
    ...
    function test_greater_than_or_equal_operator() result(tests)
        ...
        tests = describe("EnergyPerTemperatureAmount_t operator (>=)", &
                individual_tests)
    ...
    pure function checkEqualWithSameNumber(number) result(result_)
        ...
        type(EnergyPerTemperatureAmount_t) :: the_energy_per_temperature_amount

        select type (number)
        type is (DoublePrecisionInput_t)
            the_energy_per_temperature_amount = number%value_.unit.JOULES_PER_KELVIN_MOL
            result_ = assertThat( &
                    the_energy_per_temperature_amount == the_energy_per_temperature_amount, &
                    the_energy_per_temperature_amount%toString() // " == " // the_energy_per_temperature_amount%toString())
        class default
    ...
    pure function checkEqualWithDifferentNumbers(number) result(result_)
        ...
        select type (number)
        type is (DoublePrecisionInput_t)
            energy_per_temperature_amount1 = number%value_.unit.JOULES_PER_KELVIN_MOL
            energy_per_temperature_amount2 = (1.0d0 + number%value_).unit.JOULES_PER_KELVIN_MOL
            result_ = assertNot( &
                    energy_per_temperature_amount1 == energy_per_temperature_amount2, &
                    energy_per_temperature_amount1%toString() // " == " // energy_per_temperature_amount2%toString())
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithSameNumber(number) result(result_)
        ...
        type(EnergyPerTemperatureAmount_t) :: the_energy_per_temperature_amount
        type(EnergyPerTemperatureAmount_t) :: tolerance
        ...
        type is (DoublePrecisionInput_t)
            ...
            result_ = assertThat( &
                    ...
                    "(" // the_energy_per_temperature_amount%toString() // ")%equal(" &
                        // the_energy_per_temperature_amount%toString() // ", within = " &
                        // tolerance%toString() // ")")
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithCloseNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            energy_per_temperature_amount1 = number%value_.unit.JOULES_PER_KELVIN_MOL
            energy_per_temperature_amount2 = (number%value_ + 0.05d0).unit.JOULES_PER_KELVIN_MOL
            ...
            result_ = assertThat( &
                    ...
                    "(" // energy_per_temperature_amount1%toString() // ")%equal(" &
                        // energy_per_temperature_amount2%toString() // ", within = " &
                        // tolerance%toString() // ")")
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithDifferentNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            energy_per_temperature_amount1 = number%value_.unit.JOULES_PER_KELVIN_MOL
            energy_per_temperature_amount2 = (number%value_ + 0.2d0).unit.JOULES_PER_KELVIN_MOL
            tolerance = 0.1d0.unit.JOULES_PER_KELVIN_MOL
            result_ = assertNot( &
                    energy_per_temperature_amount1%equal(energy_per_temperature_amount2, within = tolerance), &
                    "(" // energy_per_temperature_amount1%toString() // ")%equal(" &
    ...
    pure function checkGreaterThanOrEqualWithGreaterNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            energy_per_temperature_amount1 = number%value_.unit. JOULES_PER_KELVIN_MOL
            energy_per_temperature_amount2 = (number%value_ - 1.0d0).unit.JOULES_PER_KELVIN_MOL
            result_ = assertThat( &
                    energy_per_temperature_amount1 >= energy_per_temperature_amount2, &
                    energy_per_temperature_amount1%toString() // " >= " // energy_per_temperature_amount2%toString())
        class default
    ...
    pure function checkGreaterThanOrEqualWithSameNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            energy_per_temperature_amount1 = number%value_.unit.JOULES_PER_KELVIN_MOL
            energy_per_temperature_amount2 = number%value_.unit.JOULES_PER_KELVIN_MOL
            result_ = assertThat( &
                    energy_per_temperature_amount1 >= energy_per_temperature_amount2, &
                    energy_per_temperature_amount1%toString() // " >= " // energy_per_temperature_amount2%toString())
        class default
...
end module energy_per_temperature_amount_logic_ops_test
