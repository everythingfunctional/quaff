...
contains
    subroutine run()
        ...
        type(TestItem_t) :: individual_tests(212)
        ...
        individual_tests(81) = energy_per_temp_amt_logic_ops_less_than_operator()
        individual_tests(82) = energy_per_temp_amt_logic_ops_greater_than_operator()
        individual_tests(83) = energy_per_temp_amt_logic_ops_less_than_or_equal_operator()
        individual_tests(84) = energy_per_temp_amt_logic_ops_greater_than_or_equal_operator()
        individual_tests(85) = energy_per_temp_amt_logic_ops_equal_within()
        individual_tests(86) = energy_per_temp_amt_logic_ops_not_equal_operator()
        individual_tests(87) = energy_per_temp_amt_logic_ops_equal_operator()
        individual_tests(88) = energy_per_temp_amt_math_ops_multiplication_division_operator()
        individual_tests(89) = energy_per_temp_amt_math_ops_addition_subtraction_operators()
        individual_tests(90) = energy_per_temp_amt_type_energy_per_temp_amt()
        individual_tests(91) = enthalpy_logic_ops_less_than_operator()
        individual_tests(92) = enthalpy_logic_ops_greater_than_operator()
        individual_tests(93) = enthalpy_logic_ops_less_than_or_equal_operator()
        individual_tests(94) = enthalpy_logic_ops_greater_than_or_equal_operator()
        individual_tests(95) = enthalpy_logic_ops_equal_within()
        individual_tests(96) = enthalpy_logic_ops_not_equal_operator()
        individual_tests(97) = enthalpy_logic_ops_equal_operator()
        individual_tests(98) = enthalpy_math_ops_multiplication_division_operator()
        individual_tests(99) = enthalpy_math_ops_addition_subtraction_operators()
        individual_tests(100) = enthalpy_type_enthalpy()
        individual_tests(101) = force_logic_ops_less_than_operator()
        individual_tests(102) = force_logic_ops_greater_than_operator()
        individual_tests(103) = force_logic_ops_less_than_or_equal_operator()
        individual_tests(104) = force_logic_ops_greater_than_or_equal_operator()
        individual_tests(105) = force_logic_ops_equal_within()
        individual_tests(106) = force_logic_ops_not_equal_operator()
        individual_tests(107) = force_logic_ops_equal_operator()
        individual_tests(108) = force_math_ops_multiplication_division_operator()
        individual_tests(109) = force_math_ops_addition_subtraction_operators()
        individual_tests(110) = force_type_force()
        individual_tests(111) = interquantity_interquantity_operators()
        individual_tests(112) = length_logic_ops_less_than_operator()
        individual_tests(113) = length_logic_ops_greater_than_operator()
        individual_tests(114) = length_logic_ops_less_than_or_equal_operator()
        individual_tests(115) = length_logic_ops_greater_than_or_equal_operator()
        individual_tests(116) = length_logic_ops_equal_within()
        individual_tests(117) = length_logic_ops_not_equal_operator()
        individual_tests(118) = length_logic_ops_equal_operator()
        individual_tests(119) = length_math_ops_multiplication_division_operator()
        individual_tests(120) = length_math_ops_addition_subtraction_operators()
        individual_tests(121) = length_type_length()
        individual_tests(122) = mass_logic_ops_less_than_operator()
        individual_tests(123) = mass_logic_ops_greater_than_operator()
        individual_tests(124) = mass_logic_ops_less_than_or_equal_operator()
        individual_tests(125) = mass_logic_ops_greater_than_or_equal_operator()
        individual_tests(126) = mass_logic_ops_equal_within()
        individual_tests(127) = mass_logic_ops_not_equal_operator()
        individual_tests(128) = mass_logic_ops_equal_operator()
        individual_tests(129) = mass_math_ops_multiplication_division_operator()
        individual_tests(130) = mass_math_ops_addition_subtraction_operators()
        individual_tests(131) = mass_type_mass()
        individual_tests(132) = molar_mass_logic_ops_less_than_operator()
        individual_tests(133) = molar_mass_logic_ops_greater_than_operator()
        individual_tests(134) = molar_mass_logic_ops_less_than_or_equal_operator()
        individual_tests(135) = molar_mass_logic_ops_greater_than_or_equal_operator()
        individual_tests(136) = molar_mass_logic_ops_equal_within()
        individual_tests(137) = molar_mass_logic_ops_not_equal_operator()
        individual_tests(138) = molar_mass_logic_ops_equal_operator()
        individual_tests(139) = molar_mass_math_ops_multiplication_division_operator()
        individual_tests(140) = molar_mass_math_ops_addition_subtraction_operators()
        individual_tests(141) = molar_mass_type_molar_mass()
        individual_tests(142) = power_logic_ops_less_than_operator()
        individual_tests(143) = power_logic_ops_greater_than_operator()
        individual_tests(144) = power_logic_ops_less_than_or_equal_operator()
        individual_tests(145) = power_logic_ops_greater_than_or_equal_operator()
        individual_tests(146) = power_logic_ops_equal_within()
        individual_tests(147) = power_logic_ops_not_equal_operator()
        individual_tests(148) = power_logic_ops_equal_operator()
        individual_tests(149) = power_math_ops_multiplication_division_operator()
        individual_tests(150) = power_math_ops_addition_subtraction_operators()
        individual_tests(151) = power_type_power()
        individual_tests(152) = pressure_logic_ops_less_than_operator()
        individual_tests(153) = pressure_logic_ops_greater_than_operator()
        individual_tests(154) = pressure_logic_ops_less_than_or_equal_operator()
        individual_tests(155) = pressure_logic_ops_greater_than_or_equal_operator()
        individual_tests(156) = pressure_logic_ops_equal_within()
        individual_tests(157) = pressure_logic_ops_not_equal_operator()
        individual_tests(158) = pressure_logic_ops_equal_operator()
        individual_tests(159) = pressure_math_ops_multiplication_division_operator()
        individual_tests(160) = pressure_math_ops_addition_subtraction_operators()
        individual_tests(161) = pressure_type_pressure()
        individual_tests(162) = quantity_lower_logic_ops_less_than_operator()
        individual_tests(163) = quantity_lower_logic_ops_greater_than_operator()
        individual_tests(164) = quantity_lower_logic_ops_less_than_or_equal_operator()
        individual_tests(165) = quantity_lower_logic_ops_greater_than_or_equal_operator()
        individual_tests(166) = quantity_lower_logic_ops_equal_within()
        individual_tests(167) = quantity_lower_logic_ops_not_equal_operator()
        individual_tests(168) = quantity_lower_logic_ops_equal_operator()
        individual_tests(169) = quantity_lower_math_ops_multiplication_division_operator()
        individual_tests(170) = quantity_lower_math_ops_addition_subtraction_operators()
        individual_tests(171) = quantity_lower_type_quantity_lower()
        individual_tests(172) = speed_logic_ops_less_than_operator()
        individual_tests(173) = speed_logic_ops_greater_than_operator()
        individual_tests(174) = speed_logic_ops_less_than_or_equal_operator()
        individual_tests(175) = speed_logic_ops_greater_than_or_equal_operator()
        individual_tests(176) = speed_logic_ops_equal_within()
        individual_tests(177) = speed_logic_ops_not_equal_operator()
        individual_tests(178) = speed_logic_ops_equal_operator()
        individual_tests(179) = speed_math_ops_multiplication_division_operator()
        individual_tests(180) = speed_math_ops_addition_subtraction_operators()
        individual_tests(181) = speed_speed()
        individual_tests(182) = speed_type_speed()
        individual_tests(183) = temperature_logic_ops_less_than_operator()
        individual_tests(184) = temperature_logic_ops_greater_than_operator()
        individual_tests(185) = temperature_logic_ops_less_than_or_equal_operator()
        individual_tests(186) = temperature_logic_ops_greater_than_or_equal_operator()
        individual_tests(187) = temperature_logic_ops_equal_within()
        individual_tests(188) = temperature_logic_ops_not_equal_operator()
        individual_tests(189) = temperature_logic_ops_equal_operator()
        individual_tests(190) = temperature_math_ops_multiplication_division_operator()
        individual_tests(191) = temperature_math_ops_addition_subtraction_operators()
        individual_tests(192) = temperature_type_temperature()
        individual_tests(193) = time_logic_ops_less_than_operator()
        individual_tests(194) = time_logic_ops_greater_than_operator()
        individual_tests(195) = time_logic_ops_less_than_or_equal_operator()
        individual_tests(196) = time_logic_ops_greater_than_or_equal_operator()
        individual_tests(197) = time_logic_ops_equal_within()
        individual_tests(198) = time_logic_ops_not_equal_operator()
        individual_tests(199) = time_logic_ops_equal_operator()
        individual_tests(200) = time_math_ops_multiplication_division_operator()
        individual_tests(201) = time_math_ops_addition_subtraction_operators()
        individual_tests(202) = time_type_time()
        individual_tests(203) = volume_logic_ops_less_than_operator()
        individual_tests(204) = volume_logic_ops_greater_than_operator()
        individual_tests(205) = volume_logic_ops_less_than_or_equal_operator()
        individual_tests(206) = volume_logic_ops_greater_than_or_equal_operator()
        individual_tests(207) = volume_logic_ops_equal_within()
        individual_tests(208) = volume_logic_ops_not_equal_operator()
        individual_tests(209) = volume_logic_ops_equal_operator()
        individual_tests(210) = volume_math_ops_multiplication_division_operator()
        individual_tests(211) = volume_math_ops_addition_subtraction_operators()
        individual_tests(212) = volume_type_volume()
