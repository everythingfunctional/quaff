...
contains
    ...
    pure function check_add_zero(input) result(result_)
        ...
        type is (double_precision_input_t)
            ...
            result_ = assert_equals(temperature, temperature + zero)
        class default
    ...
    pure function check_add_subtract(input) result(result_)
        ...
        type is (double_precision_pair_input_t)
            ...
            temperature2 = input%second_().unit.KELVIN
            result_ = assert_equals_within_relative( &
                    temperature1, &
                    (temperature1 + temperature2) - temperature2, &
                    1.0d-8, &
                    "temperature1 = " // temperature1%to_string() &
                    // ", temperature2 = " // temperature2%to_string())
        class default
