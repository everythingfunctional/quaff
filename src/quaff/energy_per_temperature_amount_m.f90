module quaff_energy_per_temperature_amount_m
    ...
    contains
        ...
        procedure :: negate_energy_per_temperature_amount
        procedure :: energy_per_temp_amt_minus_energy_per_temp_amt
        generic, public :: operator(-) => &
                negate_energy_per_temperature_amount, &
    ...
    type :: fallible_energy_per_temperature_amount_t
        private
        type(energy_per_temperature_amount_t) :: energy_per_temperature_amount_ = energy_per_temperature_amount_t(0.0d0)
    ...
    character(len=*), parameter :: MODULE_NAME = "quaff_energy_per_temperature_amount_m"
contains
    ...
    function parse_energy_per_temperature_amount_with_units_s( &
        ...
        do i = 1, size(units)
            fallible_energy_per_temperature_amount = units(i)%parse_as(string)
            if (.not. fallible_energy_per_temperature_amount%failed()) return
        end do
        fallible_energy_per_temperature_amount = fallible_energy_per_temperature_amount_t(error_list_t(fatal_t( &
                ...
                "Unable to parse '" // string // "' as a energy_per_temperature_amount_t. Tried with units: " &
    ...
    elemental function negate_energy_per_temperature_amount(self) result(negated)
        class(energy_per_temperature_amount_t), intent(in) :: self
        type(energy_per_temperature_amount_t) :: negated
