module energy_per_temperature_asserts_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use quaff, only: energy_per_temperature_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(energy_per_temperature_t), intent(in) :: expected
        type(energy_per_temperature_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(energy_per_temperature_t), intent(in) :: expected
        type(energy_per_temperature_t), intent(in) :: actual
        type(energy_per_temperature_t), intent(in) :: tolerance
        type(result_t) :: result_
