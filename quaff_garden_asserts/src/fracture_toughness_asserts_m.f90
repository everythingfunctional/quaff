module fracture_toughness_asserts_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use quaff, only: fracture_toughness_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(fracture_toughness_t), intent(in) :: expected
        type(fracture_toughness_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(fracture_toughness_t), intent(in) :: expected
        type(fracture_toughness_t), intent(in) :: actual
        type(fracture_toughness_t), intent(in) :: tolerance
        type(result_t) :: result_
