module thermal_conductivity_asserts_m
    ...
    use quaff, only: thermal_conductivity_t
...
contains
    pure function assert_equals_basic(expected, actual) result(result_)
        type(thermal_conductivity_t), intent(in) :: expected
        type(thermal_conductivity_t), intent(in) :: actual
    ...
    pure function assert_equals_within_absolute_basic( &
        ...
        type(thermal_conductivity_t), intent(in) :: expected
        type(thermal_conductivity_t), intent(in) :: actual
        type(thermal_conductivity_t), intent(in) :: tolerance
        type(result_t) :: result_
