module burnup_logical_operators_test
...
contains
    function test_equal_operator() result(tests)
        ...
        individual_tests(1) = it( &
                "is equal for the same burnup", &
                DOUBLE_PRECISION_GENERATOR, &
                checkEqualWithSameNumber)
        individual_tests(2) = it( &
                "is not equal for different burnups", &
                DOUBLE_PRECISION_GENERATOR, &
                checkEqualWithDifferentNumbers)
        tests = describe("Burnup_t with operator(==)", individual_tests)
    ...
    function test_equal_within() result(tests)
        ...
        individual_tests(1) = it( &
                "is equal for the same burnup even for tiny tolerance", &
                DOUBLE_PRECISION_GENERATOR, &
        ...
        tests = describe("Burnup_t%equal with tolerance", individual_tests)
    ...
    function test_greater_than_or_equal_operator() result(tests)
        ...
        tests = describe("Burnup_t operator (>=)", &
                individual_tests)
    ...
    pure function checkEqualWithSameNumber(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            the_burnup = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertThat( &
                    the_burnup == the_burnup, &
                    the_burnup%toString() // " == " // the_burnup%toString())
        class default
    ...
    pure function checkEqualWithDifferentNumbers(number) result(result_)
        ...
        select type (number)
        type is (DoublePrecisionInput_t)
            burnup1 = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            burnup2 = (1.0d0 + number%value_).unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertNot( &
                    burnup1 == burnup2, &
                    burnup1%toString() // " == " // burnup2%toString())
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithSameNumber(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            ...
            result_ = assertThat( &
                    ...
                    "(" // the_burnup%toString() // ")%equal(" &
                        // the_burnup%toString() // ", within = " &
                        // tolerance%toString() // ")")
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithCloseNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            burnup1 = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            burnup2 = (number%value_ + 0.05d0).unit.WATT_SECONDS_PER_KILOGRAM
            tolerance = 0.1d0.unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertThat( &
                    burnup1%equal(burnup2, within = tolerance), &
                    "(" // burnup1%toString() // ")%equal(" &
                        // burnup2%toString() // ", within = " &
                        // tolerance%toString() // ")")
        class default
            result_ = fail("Expected to get a DoublePrecisionInput_t")
        end select
    ...
    pure function checkEqualWithinWithDifferentNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            burnup1 = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            burnup2 = (number%value_ + 0.2d0).unit.WATT_SECONDS_PER_KILOGRAM
            tolerance = 0.1d0.unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertNot( &
                    burnup1%equal(burnup2, within = tolerance), &
                    "(" // burnup1%toString() // ")%equal(" &
    ...
    pure function checkGreaterThanOrEqualWithGreaterNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            burnup1 = number%value_.unit. WATT_SECONDS_PER_KILOGRAM
            burnup2 = (number%value_ - 1.0d0).unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertThat( &
                    burnup1 >= burnup2, &
                    burnup1%toString() // " >= " // burnup2%toString())
        class default
    ...
    pure function checkGreaterThanOrEqualWithSameNumbers(number) result(result_)
        ...
        type is (DoublePrecisionInput_t)
            burnup1 = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            burnup2 = number%value_.unit.WATT_SECONDS_PER_KILOGRAM
            result_ = assertThat( &
                    burnup1 >= burnup2, &
                    burnup1%toString() // " >= " // burnup2%toString())
        class default
...
end module burnup_logical_operators_test
